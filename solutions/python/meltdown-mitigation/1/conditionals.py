...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    produced = temperature * neutrons_produced_per_second
    tenpercent = threshold/10
    if produced < (threshold - tenpercent):
        return 'LOW'
    elif produced and (produced >= (threshold-tenpercent) and produced <= (threshold+tenpercent)):
        return 'NORMAL'
    else:
        return 'DANGER'
